											...
											<h5 class="mb-0 title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne">
													...
													<span class="event-status-icon"  data-toggle="modal" data-target="#public-event">
														<svg class="olymp-calendar-icon" data-toggle="tooltip" data-placement="top"   data-original-title="UNCOMPLETED"><use xlink:href="icons/icons.svg#olymp-calendar-icon"></use></svg>
													</span>
												</a>
											</h5>
										</div>
															...
															<h5 class="mb-0 title">
																<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
																	...
																	<span class="event-status-icon completed" data-toggle="modal" data-target="#public-event">
																		<svg class="olymp-checked-calendar-icon" data-toggle="tooltip" data-placement="top"   data-original-title="UNCOMPLETED"><use xlink:href="icons/icons.svg#olymp-checked-calendar-icon"></use></svg>
																	</span>
																</a>
															</h5>
														</div>
