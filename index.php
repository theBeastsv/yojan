...
<head>
    <title><? echo lang('welcome'); ?> | YOJAN</title>
    <meta charset="UTF-8">
    <meta name="description" content="YOJAN is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,YOJAN,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">YOJAN</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> YOJAN</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('YOJAN_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="YOJAN" style="width: 300px;" />
                </div>
            </div>
        </div>
        <div style="background: #fff; border-radius: 3px; max-width: 800px; padding: 15px; margin:auto;margin-top: 15px;color: #7b7b7b;" align="center">
            <? echo lang('dont_have_an_account'); ?> <a href="signup"><? echo lang('signup'); ?></a> <? echo lang('for_free'); ?>.<hr style="margin: 8px;">
                <a href="?lang=english">English</a> &bull; <a href="?lang=hindi">Hindi</a>        </div>
