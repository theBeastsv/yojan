...
<head>
    ...
    <meta name="keywords" content="social network,social media,YOJAN,meet,free platform">
...
<!--========================[ Center col2 ]===============================-->
        <div align="left">
            ...
            <!--==========[ End Account Setup ]=========-->
              <!--==========[ End Account Setup ]=========-->
                <div class="post loading-info" id="" ><? include("cpages/group.php")?>
				 <? include("groups/creategroup.php");
				 include("cpages/grouplist.php");?>
</div>
