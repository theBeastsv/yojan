	...
	<div class="header-content-wrapper">
		...
		<div class="control-block">
			...
			<div class="author-page author vcard inline-items more">
							...
							<ul class="account-settings">
								<li>
									<a href="settings.php">
										...
										<svg class="fa fa-bars"><use xlink:href="icons/icons.svg#fa fa-bars"></use></svg>
				...
				<a href="index.php" class="author-name fn">
					<div class="author-title">
						Veer <svg class="olymp-dropdown-arrow-icon"><use xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
					</div>
