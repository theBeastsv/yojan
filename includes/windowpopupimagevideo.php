<div class="modal fade hide" id="open-photo-popup-v1" style="display: none;">
	<div class="modal-dialog ui-block window-popup open-photo-popup open-photo-popup-v1">
		...
		<div class="open-photo-thumb">
			<div class="swiper-container swiper-swiper-unique-id-7 initialized swiper-container-horizontal" data-slide="fade" id="swiper-unique-id-7">
		...
		<div class="open-photo-content">
			...
			<div class="mCustomScrollbar ps ps--theme_default" data-mcs-theme="dark" data-ps-id="eb18e751-8613-4a3f-1ad6-39eacb3e3ac8">
