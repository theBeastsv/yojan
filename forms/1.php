...
$query = $conn->query("INSERT INTO signup SET createdby='$userId', about ='$aboutgroup',active='2',Email='$email' ,Username='$group_name',Fullname='$group_name',Password='$password',timeu='$mtime',language=signup_language,ctype='group',Userphoto='$imge'
